# /ultrawork — Aggressive Parallel Work Mode
...
- Final answer must include changed files, validation, and residual risks.

Stop only when the completion definition is met or a real blocker exists.
